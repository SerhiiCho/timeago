...
func TestParseUkWithOnlineFlag(t *testing.T) {
	cases := []struct {
		...
		{subSeconds(0), "В мережі"},
		{subSeconds(1), "В мережі"},
		{subSeconds(2), "В мережі"},
		{subSeconds(9), "В мережі"},
		{subSeconds(10), "В мережі"},
		{subSeconds(11), "В мережі"},
		{subSeconds(20), "В мережі"},
		{subSeconds(21), "В мережі"},
		{subSeconds(22), "В мережі"},
		{subSeconds(30), "В мережі"},
		{subSeconds(31), "В мережі"},
		{subSeconds(60), "1 хвилина тому"},
		{subMinutes(1), "1 хвилина тому"},
		{subMinutes(2), "2 хвилини тому"},
		{subMinutes(9), "9 хвилин тому"},

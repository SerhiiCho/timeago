...
func TestParseBeWithSeconds(t *testing.T) {
	cases := []struct {
		...
		{utils.SubSeconds(5), []string{"5 секунд таму", "6 секунд таму"}},
		{utils.SubSeconds(6), []string{"6 секунд таму", "7 секунд таму"}},
		{utils.SubSeconds(7), []string{"7 секунд таму", "8 секунд таму"}},
		{utils.SubSeconds(8), []string{"8 секунд таму", "9 секунд таму"}},
		...
		{utils.SubSeconds(14), []string{"14 секунд таму", "15 секунд таму"}},
		{utils.SubSeconds(16), []string{"16 секунд таму", "17 секунд таму"}},
		{utils.SubSeconds(21), []string{"21 секунда таму", "22 секунды таму"}},
		{utils.SubSeconds(23), []string{"23 секунды таму", "24 секунды таму"}},
		{utils.SubSeconds(25), []string{"25 секунд таму", "26 секунд таму"}},
		...
		{utils.SubSeconds(32), []string{"32 секунды таму", "33 секунды таму"}},
		{utils.SubSeconds(33), []string{"33 секунды таму", "34 секунды таму"}},
		{utils.SubSeconds(34), []string{"34 секунды таму", "35 секунд таму"}},
		{utils.SubSeconds(35), []string{"35 секунд таму", "36 секунд таму"}},
		{utils.SubSeconds(36), []string{"36 секунд таму", "37 секунд таму"}},
		{utils.SubSeconds(37), []string{"37 секунд таму", "38 секунд таму"}},
		{utils.SubSeconds(39), []string{"39 секунд таму", "40 секунд таму"}},
		{utils.SubSeconds(40), []string{"40 секунд таму", "41 секунда таму"}},
		{utils.SubSeconds(41), []string{"41 секунда таму", "42 секунды таму"}},
